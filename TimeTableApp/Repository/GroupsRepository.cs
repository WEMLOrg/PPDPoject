                ...
                new XElement("Groups",
                    new XElement("Group",
                        ...
                        new XElement("NecessarySubjects",
                            ...
                            new XElement("Subject", new XAttribute("SubjectId", "a2222222-2222-2222-2222-222222222222"), new XAttribute("TeacherId", "a2222222-2222-2222-2222-222222222222"), new XAttribute("Hours", "1")),
                            new XElement("Subject", new XAttribute("SubjectId", "a3333333-3333-3333-3333-333333333333"), new XAttribute("TeacherId", "a3333333-3333-3333-3333-333333333333"), new XAttribute("Hours", "1")),
                            new XElement("Subject", new XAttribute("SubjectId", "a4444444-4444-4444-4444-444444444444"), new XAttribute("TeacherId", "a4444444-4444-4444-4444-444444444444"), new XAttribute("Hours", "1")),
                            ...
                            new XElement("Subject", new XAttribute("SubjectId", "a6666666-6666-6666-6666-666666666666"), new XAttribute("TeacherId", "a6666666-6666-6666-6666-666666666667"), new XAttribute("Hours", "1")),
                            ...
                            new XElement("Subject", new XAttribute("SubjectId", "a8888888-8888-8888-8888-888888888888"), new XAttribute("TeacherId", "a8888888-8888-8888-8888-888888888888"), new XAttribute("Hours", "1")),
                            new XElement("Subject", new XAttribute("SubjectId", "a9999999-9999-9999-9999-999999999999"), new XAttribute("TeacherId", "a9999999-9999-9999-9999-999999999990"), new XAttribute("Hours", "1")),
                            new XElement("Subject", new XAttribute("SubjectId", "b1111111-1111-1111-1111-111111111111"), new XAttribute("TeacherId", "b1111111-1111-1111-1111-111111111112"), new XAttribute("Hours", "1"))
                        )
                    ),
                    new XElement("Group",
                        ...
                        new XElement("NecessarySubjects",
                            new XElement("Subject", new XAttribute("SubjectId", "a1111111-1111-1111-1111-111111111111"), new XAttribute("TeacherId", "a1111111-1111-1111-1111-111111111112"), new XAttribute("Hours", "1")),
                            new XElement("Subject", new XAttribute("SubjectId", "a2222222-2222-2222-2222-222222222222"), new XAttribute("TeacherId", "a2222222-2222-2222-2222-222222222223"), new XAttribute("Hours", "1")),
                            ...
                            new XElement("Subject", new XAttribute("SubjectId", "a4444444-4444-4444-4444-444444444444"), new XAttribute("TeacherId", "a4444444-4444-4444-4444-444444444445"), new XAttribute("Hours", "1")),
                            new XElement("Subject", new XAttribute("SubjectId", "a5555555-5555-5555-5555-555555555555"), new XAttribute("TeacherId", "a5555555-5555-5555-5555-555555555556"), new XAttribute("Hours", "1")),
                            ...
                            new XElement("Subject", new XAttribute("SubjectId", "a7777777-7777-7777-7777-777777777777"), new XAttribute("TeacherId", "a7777777-7777-7777-7777-777777777777"), new XAttribute("Hours", "1")),
                            new XElement("Subject", new XAttribute("SubjectId", "a8888888-8888-8888-8888-888888888888"), new XAttribute("TeacherId", "a8888888-8888-8888-8888-888888888889"), new XAttribute("Hours", "1")),
                            new XElement("Subject", new XAttribute("SubjectId", "a9999999-9999-9999-9999-999999999999"), new XAttribute("TeacherId", "a9999999-9999-9999-9999-999999999999"), new XAttribute("Hours", "1")),
                            new XElement("Subject", new XAttribute("SubjectId", "b1111111-1111-1111-1111-111111111111"), new XAttribute("TeacherId", "b1111111-1111-1111-1111-111111111111"), new XAttribute("Hours", "1"))
                        )
                    ),
                    new XElement("Group",
